    ...
    <footer className="border-t border-border bg-background">
      <div className="mx-auto max-w-[1600px] px-5 md:px-10 py-12 md:py-16 grid gap-10 md:grid-cols-3">
        ...
        <div>
          ...
          <p className="mt-3 text-sm text-foreground/85 max-w-xs">
        ...
        <div>
          ...
          <ul className="mt-3 space-y-1.5 text-sm">
            <li><a href="tel:+917987674523" className="hover:text-highlight">+91 79876 74523</a></li>
      ...
      <div className="border-t border-border">
        <div className="mx-auto max-w-[1600px] px-5 md:px-10 py-5 flex flex-col md:flex-row items-start md:items-center justify-between gap-2 font-mono text-[10px] tracking-[0.22em] uppercase text-muted-foreground">
          <div>© {new Date().getFullYear()} Trimurti Cement Article · All rights reserved</div>
          <div>Everything begins with a boundary.</div>
        </div>
      </div>
    </footer>
  );
