...
export function HeroBoundary() {
  ...
  return (
    ...
    >
      <img src={emptyLand} alt="" className="hero-empty absolute inset-0 h-full w-full object-cover opacity-30" />
      <img src={wallImg} alt="" className="hero-wall absolute inset-0 h-full w-full object-cover opacity-0" />
